...
#.....................................................................................#
##### Load dataframe with feeding_pressure and scaled environmental data #####
...
stk.est<-inla.stack(data=list(y=sdmdata$feeding_pressure),
                    A=list(A.est, 1),
...
##### Fitting the model #####
formula.1 <- y~-1 + beta0 +  SST + f(spatial,model=spde)
...
inla.pmarginal(0, model.est$marginals.fixed$SST)
