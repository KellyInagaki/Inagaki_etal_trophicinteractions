...
#.....................................................................................#
##### Load dataframe with occurrence and scaled environmental data #####
load("OccurrenceData.RData")
summary(sdmdata)
...
stk.est<-inla.stack(data=list(y=sdmdata$occurrence),
                    A=list(A.est, 1),
...
##### Fitting the model #####
formula.1 <- y~-1 + beta0 +  Bathy + KD + Rugosity + pH+ f(spatial,model=spde)
...
inla.pmarginal(0, model.est$marginals.fixed$KD)
1-inla.pmarginal(0, model.est$marginals.fixed$pH)
1-inla.pmarginal(0, model.est$marginals.fixed$Bathy)
inla.pmarginal(0, model.est$marginals.fixed$Rugosity)
...
abline(v=0, col="red", lwd=2)
plot(model.est$marginals.fixed$KD, type="l",main="Posterior distribution of KD")
abline(v=0, col="red", lwd=2)
plot(model.est$marginals.fixed$Bathy, type="l",main="Posterior distribution of Bathy")
abline(v=0, col="red", lwd=2)
plot(model.est$marginals.fixed$Rugosity, type="l",main="Posterior distribution of Rugosity")
abline(v=0, col="red", lwd=2)
...
#Plot occurrence quantile_0.025 
image.plot(proj.grid.mat$x, 
           proj.grid.mat$y,
           prob.0.025, axes=TRUE, xlab=("Longitude"), ylab="Latitude")
plot(wrld_simpl,add=T, axes=TRUE,col='dark grey')

#Plot occurrence quantile_0.975 
image.plot(proj.grid.mat$x, 
           proj.grid.mat$y,
